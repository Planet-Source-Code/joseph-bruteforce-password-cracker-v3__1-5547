...
Begin VB.Form frmMain 
   Caption         =   "Joseph's Bruteforce Password Cracker Version 3.00"
   ClientHeight    =   5760
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8025
   ...
   Begin TabDlg.SSTab SSTabOptions 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Tab(3).Control(0).Enabled=   0   'False
         TabCaption(4)   =   "NotePad"
         TabPicture(4)   =   "frmMain.frx":0134
         Tab(4).ControlCount=   1
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "Label37"
         Tab(4).Control(0).Enabled=   0   'False
         TabCaption(5)   =   "Add more...."
         TabPicture(5)   =   "frmMain.frx":0150
         Tab(5).ControlCount=   1
         Tab(5).ControlEnabled=   0   'False
         Tab(5).Control(0)=   "Label38"
         Tab(5).Control(0).Enabled=   0   'False
         Begin VB.Label Label38 
            Caption         =   $"frmMain.frx":016C
            ForeColor       =   &H00FF0000&
            Height          =   2415
            Left            =   -74160
            TabIndex        =   121
